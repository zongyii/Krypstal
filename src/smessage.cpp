// Copyright (c) 2014 The Krypstal developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("Krypstal-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("Krypstal-smsg-pow"); // Make this thread recognisable
